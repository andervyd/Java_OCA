...
public class StudentRunner {
    public static void main(String[] args) {
        ...
        CheckStudentOverGrade overGrade = new CheckStudentOverGrade();

        studentInfo.printStudentWithOverGrade(studentList, overGrade);

        System.out.println("======================");

        studentInfo.printStudentWithUnderGrade(studentList, overGrade);
    }
}
